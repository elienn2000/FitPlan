...
public class User : IBaseEntity
{
    ...
    public required string Username { get; set; } // Username is used as a unique identifier for the user within the application.
    ...
    public required DateOnly BirthDate { get; set; } // BirthDate is used to store the user's date of birth and is required for age verification and personalization purposes.

    public required string Country { get; set; } // Country is used to store the user's country for description purposes
    public string Description { get; set; } = ""; // Description is used to store a brief description or bio of the user for personalization and social interaction purposes.
